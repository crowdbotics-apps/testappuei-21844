"""testappuei_21844 URL Configuration
...
admin.site.site_header = "TestappUEI"
admin.site.site_title = "TestappUEI Admin Portal"
admin.site.index_title = "TestappUEI Admin"

# swagger
api_info = openapi.Info(
    title="TestappUEI API",
    default_version="v1",
    description="API documentation for TestappUEI App",
)
